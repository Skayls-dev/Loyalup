...
export function DeveloperPortal() {
  ...
  return (
    <section className="space-y-4 rounded-xl border border-zinc-800 bg-zinc-900 p-4">
      ...
      {status ? <p className="rounded-md border border-zinc-800 bg-zinc-950/60 p-2 text-xs text-zinc-300">{status}</p> : null}
      ...
      {activeTab === 'provider' ? (
        <>
          <div className="space-y-3 rounded-lg border border-zinc-800 bg-zinc-950/60 p-3">
            <p className="text-xs font-semibold text-zinc-300">Créer une clé API provider</p>
            <div className="grid gap-2 md:grid-cols-3">
              <input
                value={newKeyName}
          ...
          <div className="space-y-2">
            <p className="text-xs font-semibold text-zinc-300">Clés API provider</p>
